...
```bash
pip install jupysql_autocomplete
```
...
```bash
pip uninstall jupysql_autocomplete
```
...
# Change directory to the jupysql_autocomplete directory
...
folder is located. Then you can remove the symlink named `jupysql_autocomplete` within that folder.
